...
class arr:
    ...
    def add(self, data, user_id):
        ...
        if response.status_code in [200, 201]:
            ...
            try:
                print("Failed to add:", response.json())
            except Exception:
                print("Failed to add. Status code:", response.status_code)
            return False
